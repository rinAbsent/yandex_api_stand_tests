...
def test_create_user_space_letter_in_first_name_get_success_response():
    negative_assert_symbol("Анна и Мария")

def test_create_user_speshl_letter_in_first_name_get_success_response():
    negative_assert_symbol("№%@")

def test_create_user_num_letter_in_first_name_get_success_response():
